...
@MediumTest    //integrated test (the real dao)
class WeatherLocalDataSourceImplTest {

    private lateinit var weatherDatabase: WeatherDatabase
    private lateinit var weatherDao: WeatherDao
    private lateinit var weatherLocalDataSourceImpl: WeatherLocalDataSource
    ...
    fun setup() {
        ...
        weatherLocalDataSourceImpl = WeatherLocalDataSourceImpl(weatherDao)
    ...
    fun insertCurrentWeather_1L() = runTest {
        ...
        // When
        val res = weatherLocalDataSourceImpl.insertCurrentWeather(currentWeatherResponse)
    ...
    fun insertCurrentWeatherAndThenDeleteAndThenSelect() = runTest {
        ...
        //Given
        weatherLocalDataSourceImpl.insertCurrentWeather(currentWeatherResponse)
        val result = weatherLocalDataSourceImpl.deleteCurrentWeather(currentWeatherResponse)


        // When
        val item = weatherLocalDataSourceImpl.selectAllFavorites().first()
    ...
    fun insertCurrentWeatherAndThenSelectTheSameItem() = runTest {
        ...
        // When
        val item = weatherLocalDataSourceImpl.selectDayWeather(latitude, longitude).first()
    ...
    fun updateCurrentWeatherAndThenSelectTheUpdatedItem() = runTest {
        ...
        //Given
        weatherLocalDataSourceImpl.insertCurrentWeather(currentWeatherResponse)
        weatherLocalDataSourceImpl.updateCurrentWeather(updatedCurrentWeatherResponse)
