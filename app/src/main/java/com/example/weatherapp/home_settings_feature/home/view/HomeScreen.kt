package com.example.weatherapp.home_settings_feature.home.view
...
@Composable
fun HomeScreen(
    viewModel: HomeAndSettingsSharedViewModelImpl,
    ...
    Column(
        ...
        Row(
            ...
            Text(
                stringResource(
                    R.string.feels_like,
                    convertToArabicNumbers(currentWeather.main.feels_like.toString(),context)
                ),
...
fun LastUpdatedDisplay(currentWeather: CurrentWeatherResponse, context: Context) {
    Text(
        text = stringResource(R.string.last_updated) + convertToArabicNumbers( getTimeFromTimestamp(
