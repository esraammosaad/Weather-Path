...
class HomeViewModelImplTest {
    ...
    private lateinit var homeViewModelImpl: HomeViewModel
    ...
    fun setup() {
        ...
        homeViewModelImpl = HomeViewModelImpl(repository)
    ...
    fun getCurrentWeather_latitudeZeroAndLongitude0WithConnectedInternet() = runTest {
        ...
        //When
        homeViewModelImpl.getCurrentWeather(
            latitude = latitude,
            longitude = longitude,
    ...
    fun getFiveDaysWeatherForecast_latitudeZeroAndLongitude0WithConnectedInternet() = runTest {
        ...
        //When
        homeViewModelImpl.getFiveDaysWeatherForecast(
            latitude = latitude,
            longitude = longitude,
            isConnected = isConnected,
            languageCode = languageCode,
    ...
    fun getCountryName_latitudeZeroAndLongitude0WithConnectedInternet() = runTest {
        ...
        //When
        homeViewModelImpl.getCountryName(
            latitude = latitude,
            longitude = longitude,
            isConnected = isConnected,
            geocoder =geocoder,
